...
function segurarPagina(e){
    ...
    if(aprovado1 == true && aprovado2 == true && aprovado3 == true){
        ...
        if(idade >= 18){
            ...
            pessoaCadastrada.innerHTML = `Nome: ${inputNome.value} - Idade: ${idade} anos - Email: ${inputEmail.value} - Modo: ${modo.value}`;
            lista.appendChild(pessoaCadastrada)
            info = document.createElement('p')
            info.innerHTML = 'Cadastro realizado com sucesso!';
...
function verificaNomeDataEmail(){
    ...
    if(inputNome.value === ''){
        ...
        errorNome.innerHTML = 'Digite seu nome';
    ...
    if (!dataPadrao.test(inputDataNascimento.value)){
        ...
        errorData.innerHTML = 'Insira sua data de nascimento no seguinte formato: dd/mm/aaaa';
    ...
    if (!emailPadrao.test(inputEmail.value)){
        ...
        errorEmail.innerHTML = 'Insira um e-mail válido!';
...
function removerLista(){
    numeroLista = window.prompt('Digite o nº de cadastro que deseja excluir!');
